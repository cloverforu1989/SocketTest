...
public class GameScene extends Scene{
    private  static Vector msg = new Vector();
...
//		//msg.addElement(obj);
//		RemoteControlMain.log("msg from server", obj);
//	}
	...
	public static void _keyPressed(int keCode) {
		...
		// TODO Auto-generated method stub
		RemoteControlMain.log("r", keCode+"");
		switch(keCode) {
...
//				}
	...
	public  void keyPressed(int keyCode) {
		...
		case RemoteKey.KEY_RIGHT_UP:
		case RemoteKey.KEY_RIGHT_DOWN:
		case RemoteKey.KEY_LEFT:
		case RemoteKey.KEY_RIGHT:
